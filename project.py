...
def gconnect():
    ...
    if result['issued_to'] != CLIENT_ID:
        response = make_response(json.dumps("Token client id does not match given user id"), 401)
        response.headers['Content-Type'] = 'application/json'
        return response
    ...
    if stored_credentials is not None and gPlus_id == stored_gPlus_id:
        response = make_response(json.dumps("Current user is already logged connected."), 200)
        response.headers['Content-Type'] = 'application/json'
